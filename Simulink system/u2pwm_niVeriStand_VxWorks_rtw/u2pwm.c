 ...
 * C source code generated on : Mon Feb 12 13:19:48 2018
 *
...
void u2pwm_output(void)
{
  ...
  if (u2pwm_B.enable_mech_el != 0.0) {
    ...
    b_signal = u2pwm_B.MultiportSwitch[5];
    ...
    rtb_Switch_idx_5 = u2pwm_B.MultiportSwitch[2];
...
RT_MODEL_u2pwm_T *u2pwm(void)
{
  ...
  u2pwm_M->Sizes.numBlocks = (129);    /* Number of blocks */
  u2pwm_M->Sizes.numBlockIO = (50);    /* Number of block outputs */
  u2pwm_M->Sizes.numBlockPrms = (461); /* Sum of parameter "widths" */
  return u2pwm_M;
}
 ...
 * Source generated on : Mon Feb 12 13:19:48 2018
 *========================================================================*/
...
static const char* NI_CompiledModelDateTime = "Mon Feb 12 13:19:48 2018";
