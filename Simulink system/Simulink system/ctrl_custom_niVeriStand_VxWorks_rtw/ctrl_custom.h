...
typedef struct {
  ...
  real_T x_m_DWORK1;                   /* '<S2>/x_m' */
  real_T y_m_DWORK1;                   /* '<S2>/y_m' */
  real_T psi_m_DWORK1;                 /* '<S2>/psi_m' */
  ...
  uint8_T x_m_DWORK2[12];              /* '<S2>/x_m' */
  uint8_T y_m_DWORK2[12];              /* '<S2>/y_m' */
  uint8_T psi_m_DWORK2[12];            /* '<S2>/psi_m' */
  uint8_T alpha_VSP2_DWORK2[12];       /* '<S3>/alpha_VSP2' */
  uint8_T omega_VSP1_DWORK2[12];       /* '<S3>/omega_VSP1' */
  uint8_T omega_VSP2_DWORK2[12];       /* '<S3>/omega_VSP2' */
  uint8_T alpha_VSP1_DWORK2[12];       /* '<S3>/alpha_VSP1' */
  uint8_T u_BT_DWORK2[12];             /* '<S3>/u_BT' */
  uint8_T u_VSP1_DWORK2[12];           /* '<S3>/u_VSP1' */
  uint8_T u_VSP2_DWORK2[12];           /* '<S3>/u_VSP2' */
} DW_ctrl_custom_T;
