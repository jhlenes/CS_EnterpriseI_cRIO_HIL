...
void CSE1_HIL_u_output(void)
{
  ...
  /* End of Integrator: '<Root>/Position' */
  ...
  /* End of Integrator: '<Root>/Velocity' */
  if (rtmIsMajorTimeStep(CSE1_HIL_u_M)) {
  }
  ...
  b_y0 = (atan(-10.22 * CSE1_HIL_u_B.Velocity[0] + 2.947) * 0.3075 + 0.7561) *
    b_y0 / 1.1385;
  for (i = 0; i < 3; i++) {
    tau[i] = a[i + 6] * b_y0 + (a[i + 3] * tmp_3 + a[i] * c_23);
  }
  ...
  /*  Correolis matrix */
  /* '<S6>:1:49' */
  b_y0 = -24.11 * CSE1_HIL_u_B.Velocity[1] - 0.529125 * CSE1_HIL_u_B.Velocity[2];

  /* '<S6>:1:50' */
  c_23 = 16.11 * CSE1_HIL_u_B.Velocity[0];
  ...
  tau_0[0] = CSE1_HIL_u_B.X;
  tau_0[1] = CSE1_HIL_u_B.Y;
  tau_0[2] = CSE1_HIL_u_B.N;
  for (i = 0; i < 3; i++) {
    tau[i] = tau_0[i] - (tmp_1[i + 6] * CSE1_HIL_u_B.Velocity[2] + (tmp_1[i + 3]
      * CSE1_HIL_u_B.Velocity[1] + tmp_1[i] * CSE1_HIL_u_B.Velocity[0]));
  }

  CSE1_HIL_u_B.nu_dot[0] = tau[0];
  CSE1_HIL_u_B.nu_dot[1] = tau[1] - CSE1_HIL_u_B.nu_dot[0] * 0.0;
  CSE1_HIL_u_B.nu_dot[2] = (tau[2] - CSE1_HIL_u_B.nu_dot[0] * 0.0) -
...
void CSE1_HIL_u_initialize(void)
{
  ...
  /* End of InitializeConditions for Integrator: '<Root>/Position' */
...
static NI_Signal NI_SigList[] DataSection(".NIVS.siglist") =
{
  ...
  { 4, "cse1_hil_u/Position/(1, 1)", 0, "", offsetof(B_CSE1_HIL_u_T, Position) +
    (0*sizeof(real_T)), BLOCKIO_SIG, 18, 1, 2, 0, 0 },

  { 5, "cse1_hil_u/Position/(1, 2)", 0, "", offsetof(B_CSE1_HIL_u_T, Position) +
    (1*sizeof(real_T)), BLOCKIO_SIG, 18, 1, 2, 0, 0 },

  { 6, "cse1_hil_u/Position/(1, 3)", 0, "", offsetof(B_CSE1_HIL_u_T, Position) +
    (2*sizeof(real_T)), BLOCKIO_SIG, 18, 1, 2, 0, 0 },

  { 7, "cse1_hil_u/Velocity/(1, 1)", 0, "", offsetof(B_CSE1_HIL_u_T, Velocity) +
    (0*sizeof(real_T)), BLOCKIO_SIG, 18, 1, 2, 0, 0 },

  { 8, "cse1_hil_u/Velocity/(1, 2)", 0, "", offsetof(B_CSE1_HIL_u_T, Velocity) +
    (1*sizeof(real_T)), BLOCKIO_SIG, 18, 1, 2, 0, 0 },

  { 9, "cse1_hil_u/Velocity/(1, 3)", 0, "", offsetof(B_CSE1_HIL_u_T, Velocity) +
    (2*sizeof(real_T)), BLOCKIO_SIG, 18, 1, 2, 0, 0 },
  ...
  { 20, "cse1_hil_u/kinetics", 0, "(1, 1)", offsetof(B_CSE1_HIL_u_T, nu_dot) +
    (0*sizeof(real_T)), BLOCKIO_SIG, 18, 1, 2, 0, 0 },

  { 21, "cse1_hil_u/kinetics", 0, "(1, 2)", offsetof(B_CSE1_HIL_u_T, nu_dot) +
    (1*sizeof(real_T)), BLOCKIO_SIG, 18, 1, 2, 0, 0 },

  { 22, "cse1_hil_u/kinetics", 0, "(1, 3)", offsetof(B_CSE1_HIL_u_T, nu_dot) +
    (2*sizeof(real_T)), BLOCKIO_SIG, 18, 1, 2, 0, 0 },

  { 23, "cse1_hil_u/kinematics", 0, "(1, 1)", offsetof(B_CSE1_HIL_u_T, eta_dot)
    + (0*sizeof(real_T)), BLOCKIO_SIG, 18, 1, 2, 0, 0 },

  { 24, "cse1_hil_u/kinematics", 0, "(1, 2)", offsetof(B_CSE1_HIL_u_T, eta_dot)
    + (1*sizeof(real_T)), BLOCKIO_SIG, 18, 1, 2, 0, 0 },

  { 25, "cse1_hil_u/kinematics", 0, "(1, 3)", offsetof(B_CSE1_HIL_u_T, eta_dot)
    + (2*sizeof(real_T)), BLOCKIO_SIG, 18, 1, 2, 0, 0 },

  { 26, "cse1_hil_u/T Thruster configuration matrix", 0, "", offsetof
    (B_CSE1_HIL_u_T, X) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 27, "cse1_hil_u/T Thruster configuration matrix", 1, "", offsetof
    (B_CSE1_HIL_u_T, Y) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },
